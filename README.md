...
The classes [birds](birds.py) and [field](field.py) have been updated in order to include the cost for collision (which was not present in the original codebae).
