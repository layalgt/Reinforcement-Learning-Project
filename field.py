"""
This is the modified version of the class field... basically we just pass on a new argument collision-distance
"""
...
class Field(object):
    ...
    def __init__(self, numbirds, sim_length = 12500, record_mov = False,
                 ...
                 record_every = 500, collision_distance = 10 .0, **kwargs):
